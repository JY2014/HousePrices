...
### variables with less than 10 values are likely to be categorical
...
# extract columns with less than 10 values       
value_num = np.asarray(value_num)
categorical_names = train_dropped.columns[value_num <= 10]
...
missing_cat_names = list(set(missing_column_names)-
(set().union(categorical_final, missing_column_names) -set(categorical_final)))
